...
int main(){
    ...
    BN_set_word(ea, RSA_F4);
    //TPRSA_key_gen(client_key,1024);
    RSA_generate_key_ex(client_key, 1024, ea, NULL);
    ...
    //TPRSA_SK_Gen_Key_ds(C, 1024, na, ea, ds);
    //TPRSA_SK_Get_d(C, da);             
    //BN_add(d, da, ds);
    //TPRSA_SK_Set_d(C, d);
    TPRSA_SK_DivKey_ds(C, na, ea, ds);
